 ...
 * @author hayong
 */
@WebServlet(urlPatterns = {"/DBsousa12"})
public class DBsousa12 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            printResults(out,request.getParameter("name"),request.getParameter("age"),request.getParameter("birthday")); 
     ...
     public void printResults(PrintWriter out,String name1,String age1,String birthday1){
    ...
    try{
       ...
       db_st.setInt(2,Integer.parseInt(age1));
       db_st.setDate(3,Date.valueOf(birthday1));
